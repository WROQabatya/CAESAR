...
SoftwareSerial audioSerial(30, 31); // RX, TX
DFRobotDFPlayerMini myDFPlayer;

void speakInit(){
  audioSerial.begin(9600);
  if (!myDFPlayer.begin(audioSerial)) { Serial.println(F("DFPlayer Mini Error."));  }
...
#define PWM             5
#define M1              4                       // PWM outputs to L298N H-Bridge motor driver module
#define M2              3
#define Motor 44
#define BTN 13
#define MOD 14
                ...
                if (counter > 11 ) 
                         {
                            ...
                            drvEncoderSpeed((stopDistance/2)-5,normalSpeed);
                            x=1;
                            break;
                          }
                 }
...
if (t<8) {t=0;}
                ...
                if (counter > 11 ) 
                         {
                            int stopDistance = deltaStrightDifference(100);
                            drvEncoderSpeed(10,normalSpeed);
                            x=1;
                            break;
                          }
